    ...
    function amountAfterDiscount(total) {
        shoppers.forEach(function(originalAmount) {
            if (originalAmount.amount > 200) {
                ...
                var totalDiscount = originalAmount.amount - discount;
            console.log("Hello, " + originalAmount.name + "!" + " Your total today is " + originalAmount.amount + "." + " Your discount today is " + discount.toFixed(2) + "." + " This brings your total to " + totalDiscount.toFixed(2) + ".")
            } else {
                console.log("Hello, " + originalAmount.name + "." + " Your total today is " + originalAmount.amount + " because you did not spend above 200.")
            }
        });
    }
    amountAfterDiscount()
